...
* **Documentation**
  ...
  * DeveloperGuide
    * Added UML sequence diagram for the `deleteTransactionCommand`.
    * Added **class diagram for the `UserInterface` API** to illustrate command flow and component interactions.
